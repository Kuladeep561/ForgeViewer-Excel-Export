...
app.use(
  "/css/jstree",
  express.static(__dirname + "/../node_modules/jstree/dist/themes/default")
); // redirect static calls (jstree use 'style.css', which is very generic, so let's use an extra folder)
app.use(
  "/fonts",
  express.static(__dirname + "/../node_modules/bootstrap/dist/fonts")
); // redirect static calls
app.set("port", process.env.PORT || 1235); // main port
